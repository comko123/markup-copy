  ...
  return (
    <>
      <nav className="sticky top-24 border-b-2 lg:border-r-2 lg:border-b-transparent border-gray-300 w-full h-[100vh] lg:pr-5">
        ...
        >
          {/* svg part */}
          <div className="h-32 mt-4 lg:mt-0 flex flex-col">
            <div>
              <svg
            ...
            <div className="flex justify-center -mt-7">
              <div className="flex w-28 justify-between">
                ...
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-6 aspect-square bg-white  rounded-full border-2 border-black"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <div className="flex flex-col h-auto">
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              onClick={() => setProfilState(state => !state)}
              viewBox="0 0 24 24"
              strokeWidth={1.5}
              stroke="currentColor"
