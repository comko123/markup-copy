...
<header className="bg-blue-500 flex justify-between p-2 md:p-5 px-6 lg:px-24 font-bold fixed top-0 w-full z-10">
 ...
 {modalShowing?
  ...
  className="fixed right-[2%] overflow-auto scrollbar-hide md:right-[1%] lg:right-[2%] top-[2.2em] md:top-[3em] xl:top-[3.8em] origin-top w-[14rem] md:w-[16rem] h-[17.5rem] md:h-[18.5rem] my-2 bg-pink-100 rounded-xl">
