...
export const listAtom = atom<state>({
    key:`list_state${v1()}`,
    default:{"To Do":[
        {title:"SpringBoot 2강 듣기",category:{main:"공부",sub:"인강"},date:"2022.12.01~2022.12.31",level:"High",id:v1()},
        {title:"헬스장 가기",category:{main:"운동",sub:"핼스"},date:"2022.12.01~2022.12.31",level:"Medium",id:v1()},
        {title:"쓰레기 버리기",category:{main:"일상",sub:"가사"},date:"2022.12.01~2022.12.31",level:"Low",id:v1()}],
        "In Progress":[
        {title:"React 5강 듣기",category:{main:"공부",sub:"인강"},date:"2022.12.01~2022.12.31",level:"High",id:v1()},
