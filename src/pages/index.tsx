  ...
  return (
     <LayOut login={login}>
      {login?
       ...
       <section className="flex mt-2 lg:mt-5 flex-col w-full md:flex-row md:[&>*:nth-child(even)]:mx-5 md:[&>*:nth-child(even)]:my-0 [&>*:nth-child(even)]:my-5" id="list_prat">
...
<div className="bg-blue-500 text-center py-2 text-white rounded-md">{itemList} ({dialog[itemList].length})</div>
         ...
         {dialog[itemList].map(item=>{
           ...
           onClick={()=>{setPuState(state=>!state);setMainInfo(()=>{return{itemList,title:item.title}})}}>
             ...
             <div className="text-vxs 2xl:text-[0.1em] flex w-full [&>*]:w-max">
