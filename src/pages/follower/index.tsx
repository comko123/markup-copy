  ...
  useLoginCheck(login)
    return(<LayOut login={login}>
      <div className="flex mx-6 md:mx-10 lg:mx-14 my-10">
       ...
       <div className={`bg-gray-100 w-48 lg:w-72 ${state.profilState?"h-[18rem] lg:h-80":"h-[21rem] lg:h-96"} rounded-xl pt-2 relative shadow-xl`}>
...
<aside className="overflow-x-hidden pt-3 w-[80%]">
    <div className="flex font-bold justify-between px-8 w-full text-xs md:text-lg ml-2 lg:ml-9 border-b-2 border-gray-300 pb-3">
        <div className={`mx-auto ${state.follower?"ring-4 ring-blue-500 ring-offset-3":null} text-sm md:text-lg p-2 rounded-lg`}
        onClick={()=>setState(state=>{return{...state,follower:true,request:false}})}
        >Follower</div>
        <div className={`mx-auto p-2 rounded-lg relative ${state.request?"ring-4 ring-blue-500 ring-offset-3":null} text-sm md:text-lg`}
